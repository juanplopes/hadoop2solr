...
#
# Example:
# export AMI_IMAGE_M1_LARGE=ami-18ec1871
#
...
if [ -n "$1" ]; then
    export KEY_NAME=$1
    set -- # unset the $1 positional parameter so bixo/setenv.sh won't think it specifies a profile
else
    export KEY_NAME=bixolabs-shared
fi
